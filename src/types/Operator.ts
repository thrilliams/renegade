...
export type Operator =
	...
	// Positional operators are supported. A field name like "values.1" refers to the item at index 1 in the values array.
	// Currently unpredictable for non-number sorts.
	| {
			$sortArray: {
				input: Operator;
				sortBy: Operator;
	...
	/// These do not currently respect BSON type comparison order.
	...
	| { $setDifference: [Operator, Operator] }
